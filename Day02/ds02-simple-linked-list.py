...
def insertNode(findData, insertData):
    global memory, pre, current, head # 가져와 쓰겠다
    ...
    current = head # current를 제일 앞으로 땡겨줌
    while current.link != None: # 중간노드 추가. 제일마지막이 아닐동안
        pre = current
        current = current.link # current 뒤로 감
